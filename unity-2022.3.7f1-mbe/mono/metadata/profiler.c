...
{
	// if desc is "etw", return as we don't want Unity to load the profiler
	if (!desc || !strcmp ("etw", desc))
		return;
	const char *col;
	char *mname, *libname;
 ...
 */
 ...
 // this is a patched version of Mono with special debugging support, we don't want this enabled
#ifndef RUNTIME_IL2CPP
mono_bool
mono_profiler_enable_coverage (void)
{
	//unequivocally return
	return FALSE;
